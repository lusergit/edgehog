...
defmodule Edgehog.Containers.DeviceMapping.Deployment.Provisioner do
  ...
  def handle_continue(
        ...
        %{device_mapping_deployment: device_mapping_deployment} = state
      ) do
    device_mapping_deployment =
      Ash.load!(device_mapping_deployment, :is_ready, tenant: device_mapping_deployment.tenant_id)

    if device_mapping_deployment.is_ready do
