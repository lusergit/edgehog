...
## [0.13.0](https://github.com/lusergit/edgehog/compare/backend-v0.12.0...backend-v0.13.0) (2026-03-24)
...
* add GraphQL subscriptions for containers ([#1224](https://github.com/lusergit/edgehog/issues/1224)) ([6c36e6d](https://github.com/lusergit/edgehog/commit/6c36e6d0e632251f64a6ffef4a2a304f658f55ad))
* add GraphQL subscriptions for OTA operations ([#1220](https://github.com/lusergit/edgehog/issues/1220)) ([db679ce](https://github.com/lusergit/edgehog/commit/db679ceebe687909871ed3fee9e59303b4397aa0))
...
* Add subscriptions for HT and SMPN ([#1225](https://github.com/lusergit/edgehog/issues/1225)) ([7d46654](https://github.com/lusergit/edgehog/commit/7d466541e3b77f87d84884332046a677d102b441))
...
* **backend:** Add CORS policy for GraphQL subscriptions ([#1272](https://github.com/lusergit/edgehog/issues/1272)) ([3d77c0a](https://github.com/lusergit/edgehog/commit/3d77c0a368c94e7ca5504a8947268327c5de2d6f))
* **backend:** Add single file download request feature ([799479c](https://github.com/lusergit/edgehog/commit/799479c474b3b67a9cf7eb3e62879d282ed3a0ab))
* **backend:** add subscriptions to campaigns domain ([2bda866](https://github.com/lusergit/edgehog/commit/2bda8661d064a4eb45ade539058930e1b54ddefb))
...
* **backend:** allow devs to setup database connection ([649829a](https://github.com/lusergit/edgehog/commit/649829af09106f283e6b929abec2987fbc7cd8fa))
* **backend:** base_images subscriptions ([bf28b85](https://github.com/lusergit/edgehog/commit/bf28b85f909e6cfa1a2d8faf0979a4904073df67))
...
* **backend:** run tenant reconciliation at creation ([f806909](https://github.com/lusergit/edgehog/commit/f806909c1159ffd6f9171885f8ccee96f2a6f582))
...
* OTA updates can be canceled ([1daed60](https://github.com/lusergit/edgehog/commit/1daed60e4fa6af858208f4b3fe3c3863006168c3)), closes [#266](https://github.com/lusergit/edgehog/issues/266)
...
* **backend:** DeploymentEvent interface not working ([eed0dcb](https://github.com/lusergit/edgehog/commit/eed0dcbb031653c791577f6bbe9677dcc65191c3))
* **backend:** log errors instead of crashing ([899f431](https://github.com/lusergit/edgehog/commit/899f4315f01e67331057dcd11c4dbf0bee11c734))
...
* correct load of realm management client ([d03e737](https://github.com/lusergit/edgehog/commit/d03e737bd28a9d2a5af928dda4293bc84aff6df7))
...
* device reconciliation not working ([ba1b025](https://github.com/lusergit/edgehog/commit/ba1b02530283f69de9cafa5ce4a19cdb117de285))
...
* do not erase device names ([f7a9e85](https://github.com/lusergit/edgehog/commit/f7a9e854bd9a0b5f545649401b2f121a526a00b9))
...
* Handle reconciler task replies ([bec0758](https://github.com/lusergit/edgehog/commit/bec075870002b9e7c9213e7d9d0eeb2fd763d890))
...
* S3 presign host parsing for schemeless asset hosts ([39ff3f0](https://github.com/lusergit/edgehog/commit/39ff3f05f4383b8b9b1f87c8aaa18067b160c854))
...
* Wrong endpoint type in ServerToDevice for fileSizeBytes ([d43c948](https://github.com/lusergit/edgehog/commit/d43c94851a57bec9a870be8a6c0c65729e3b3023))
