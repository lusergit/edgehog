...
defmodule Edgehog.Campaigns.CampaignTargetTest do
  @moduledoc false
  ...
  describe "next_valid_target_with_application_deployed" do
    ...
    test "only returns targets with idle status", %{tenant: tenant} do
      ...
      campaign = Ash.load!(target, :campaign, tenant: tenant).campaign
      ...
      release = campaign_mechanism.value.release
      ...
      Campaigns.mark_target_as_in_progress(target, tenant: tenant)
